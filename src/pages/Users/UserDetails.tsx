    ...
    <>
      ...
      <div className="max-w-[1300px] mx-auto pb-10">
        <div className="hidden sm:flex flex-wrap items-center xl:justify-between py-5 gap-10 border-b">
          ...
          <div>
            <div className="text-[10px]">0{user?.phonenumber }</div>
          ...
          <div>
            ...
            <div className="text-[14px] font-semibold">{user?.salary}</div>
          </div>
          <div>
            <div className="text-[10px]">User type</div>
            <div className="text-[14px] font-semibold">{ user?.role}</div>
          </div>
          <div>
            <div className="text-[10px]">Joined</div>
            <div className="text-[14px] font-semibold">{moment(user?.createdAt).format("DD/MM/YY")}</div>
          </div>
        </div>
